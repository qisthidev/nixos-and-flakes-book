...
titleTemplate: "Halaman Beranda"

hero:
  name: "NixOS & Flakes Book"
  text: "Panduan tidak resmi untuk pemula"
  tagline:
    Ingin mengenal NixOS & Flakes secara mendalam? Mencari tutorial yang ramah pemula? Anda datang ke tempat yang tepat!
  image:
    src: /logo.png
    alt: NixOS Flakes
  actions:
